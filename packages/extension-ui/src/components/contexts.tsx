...
import type { AccountsContext, AuthorizeRequest, MetadataRequest, SigningRequest, DecryptingRequest } from '@polkadot/extension-base/background/types';
...
const DecryptingReqContext = React.createContext<DecryptingRequest[]>([]);
